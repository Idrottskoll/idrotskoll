            ...
            <div>
                ...
                <div className="row tm-80">
                    <div className="large-12">
                        <Title>Tablå</Title>
                        <Paragraph>
                            Här kan du se dem planerade livestreams som kommer att finna på
                            Idrottskoll.se. <br />
                            Intresserad av att lägga en beställning? Kontakta oss på
                            info@idrottskoll.se eller använd förmuläret{' '}
                            <a href="/inspelningsforfragan">här.</a>
                        </Paragraph>
